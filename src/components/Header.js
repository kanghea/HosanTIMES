          ...
          <div className="w-full h-full flex grow-0 bg-white/90 justify-between content-center items-center lg:px-52" id="main-header">
            ...
            <div className="flex-none basis-96 w-72">
              <div className="text-xs flex flex-row">
                ...
                <a className="basis-48 bg-white border-solid rounded-3xl h-10 align-middle text-center pt-2 items-center hover:bg-slate-100 text-sm border-2 border-gray-300" href='/website'><strong>종로학원 선생님 모드 ➜</strong></a>
